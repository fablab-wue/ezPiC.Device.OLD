...
class MicroWebSrv :
    ...
    def __init__( self,
        ...
        self.LetCacheStaticContentLevel = 2 #JKJKJK
    ...
    class _client :
        ...
        def _processRequest(self) :
            ...
            except Exception as ex: #JK
                response.WriteResponseInternalServerError(str(ex))
            try :
    ...
    class _response :
        ...
        def WriteResponseError(self, code, addText=None) : #JK
            responseCode = self._responseCodes.get(code, ('Unknown reason', ''))
            responseText = self._errCtnTmpl % {
                                            'code'    : code,
        ...
        def WriteResponseInternalServerError(self, addText=None) : #JK
            return self.WriteResponseError(500, addText)
